...
vim.keymap.set('n', '<leader>g', ':Neotree position=float source=git_status<CR>')

-- Bufferline
vim.keymap.set('n', '<leader>bc', ':bd<CR>')
vim.keymap.set('n', '<leader>bp', ':BufferLinePick<CR>')
vim.keymap.set('n', ']t', ':BufferLineCycleNext<CR>')
vim.keymap.set('n', '[t', ':BufferLineCyclePrev<CR>')
